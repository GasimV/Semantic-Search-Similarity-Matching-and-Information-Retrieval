...
sys.path.append('C:\\Users\Rog\Desktop\\NLP project')
...
class Stemmer:
    ...
    def __load_words(self):
        ...
        with open(sorted(pathlib.Path('..').glob('**/words.txt'))[0], "r", encoding="utf8") as words_file:
    ...
    def __load_suffixes(self):
        ...
        with open(sorted(pathlib.Path('..').glob('**/suffix.txt'))[0], "r", encoding="utf8") as suffix_file:
